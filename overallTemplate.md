...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    @media only screen and (max-width: 480px) {
      ...
      .container50{width:50% !important;}
      .container55{width:55% !important;}
      .container60{width:60% !important;}
      .container70{width:70% !important;}
      ...
      .photo60{width:60% !important;height:auto !important;}
      .photo70{width:70% !important;height:auto !important;}
      ...
      .allpad{padding:25px!important;}
      .mobpad{padding:0 25px 25px 25px!important;}
      .botpad{padding:0 0 25px 0!important;}
      .toppad{padding:25px 0 0 0!important;}
      .sidepad{padding:0 25px!important;}
      .tbpad{padding:25px 0!important;}
      .container49{width:49% !important;}
      .tcpad{padding:0 0 20px 0!important;}
      .lineheading{font-size:18px!important;padding:0 20px!important;}
      .headbg {background-size:100% 100%}
    ...
    @media only screen and (max-width: 359px) {
      ...
      .mobpad{padding:0 15px 15px 15px!important;}
      .botpad{padding:0 0 15px 0!important;}
  ...
  <body style="margin: 0px; padding:0px; -webkit-text-size-adjust:none; -ms-text-size-adjust: none;" yahoo="fix">
    ...
    <table id="parent-table" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#222222">
      <tr>
        <td align="center" valign="top" width="100%">
          <table class="container" id="content-table" width="700" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="min-width:320px;">
            <!--content area 1-->
            <tr>
              <td align="center">
                .
